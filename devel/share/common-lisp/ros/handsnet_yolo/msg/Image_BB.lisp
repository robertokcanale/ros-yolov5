...
(cl:defclass <Image_BB> (roslisp-msg-protocol:ros-message)
  ((bb_number
   ...
   (bb_array
    :reader bb_array
    :initarg :bb_array
    :type (cl:vector handsnet_yolo-msg:BB)
   :initform (cl:make-array 0 :element-type 'handsnet_yolo-msg:BB :initial-element (cl:make-instance 'handsnet_yolo-msg:BB))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Image_BB>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Image_BB)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name handsnet_yolo-msg:<Image_BB> is deprecated: use handsnet_yolo-msg:Image_BB instead.")))

(cl:ensure-generic-function 'bb_number-val :lambda-list '(m))
(cl:defmethod bb_number-val ((m <Image_BB>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader handsnet_yolo-msg:bb_number-val is deprecated.  Use handsnet_yolo-msg:bb_number instead.")
  (bb_number m))

(cl:ensure-generic-function 'bb_array-val :lambda-list '(m))
(cl:defmethod bb_array-val ((m <Image_BB>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader handsnet_yolo-msg:bb_array-val is deprecated.  Use handsnet_yolo-msg:bb_array instead.")
  (bb_array m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Image_BB>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'bb_array)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'handsnet_yolo-msg:BB))
