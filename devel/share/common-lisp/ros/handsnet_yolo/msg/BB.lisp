...
(cl:defmethod obj_class-val ((m <BB>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader handsnet_yolo-msg:obj_class-val is deprecated.  Use handsnet_yolo-msg:obj_class instead.")
  (obj_class m))
